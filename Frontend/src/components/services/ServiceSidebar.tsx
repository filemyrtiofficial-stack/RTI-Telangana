...
export const ServiceSidebar: React.FC<ServiceSidebarProps> = React.memo(({ model, onCTAClick, serviceSlug }) => {
  ...
  return (
    <>
      ...
      >
        <div
          className="bg-gradient-to-br from-blue-800 via-blue-900 to-blue-950 rounded-l-lg border-t border-b border-l border-blue-900 p-4 h-full flex flex-col"
          style={{
            height: '100%',
            maxHeight: '100%',
            overflow: 'hidden',
        ...
        >
          ...
          <button
            onClick={() => navigate('/')}
            className="w-full mb-3 bg-transparent hover:bg-blue-800/30 text-white font-semibold py-2 px-3 rounded-lg transition-all duration-200 flex items-center justify-center gap-2 flex-shrink-0"
          ...
          <div className="flex-1 flex flex-col min-h-0 overflow-hidden" style={{ overflow: 'hidden' }}>
            ...
            {/* What Will You Get */}
            <div className="flex-1 flex flex-col min-h-0 overflow-hidden" style={{ overflow: 'hidden' }}>
              <h4 className="text-base font-bold text-white mb-3 flex-shrink-0">What Will You Get:</h4>
              <div 
          ...
          <div className="mt-4 flex-shrink-0">
            <button
              onClick={onCTAClick}
              className="w-full bg-white hover:bg-gray-50 text-blue-900 font-bold py-2.5 px-4 rounded-lg transition-all duration-200 shadow-md hover:shadow-lg border-2 border-white flex items-center justify-center gap-2 text-sm"
            >
              File Now
            </button>
          </div>
